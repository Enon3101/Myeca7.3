...
```bash
PHASE_INFO=$(node "C:/Users/jitsu/Desktop/Myeca7.3/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "C:/Users/jitsu/Desktop/Myeca7.3/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "C:/Users/jitsu/Desktop/Myeca7.3/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
